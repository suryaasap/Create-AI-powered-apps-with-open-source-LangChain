...
import os
# Mengatur LLM
os.environ["OPENAI_API_KEY"] = "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"
...
def handle_complaint(komplain: str) -> str:
    ...
    prompt = PromptTemplate(input_variables=["komplain"], template="Saya seorang perwakilan layanan pelanggan. ada masalah apa kau rupanya: {komplain}. Respon saya adalah:")
